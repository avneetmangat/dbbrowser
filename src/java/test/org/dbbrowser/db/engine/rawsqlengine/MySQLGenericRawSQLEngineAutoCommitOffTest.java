...
public class MySQLGenericRawSQLEngineAutoCommitOffTest extends TestCase
{
    private GenericRawSQLEngine genericRawSQLEngine = null;
    private Connection conn = null;

    public MySQLGenericRawSQLEngineAutoCommitOffTest(String name)
    {
        super(name);
    }
    ...
    public void setUp()
    {
        try
        {
            ...
            if( ci != null )
            {
                this.conn = DBBrowserDriverManager.getInstance().getConnection( ci, null );
    ...
    public void testRunRawSelectSQLStatement()
    {
        try
        {
            Log.getInstance().debugMessage("*** MySQLGenericRawSQLEngineAutoCommitOffTest.testRunRawSelectSQLStatement *** ", this.getClass().getName());

            DBTable dbTable = this.genericRawSQLEngine.runRawSQL("select count(*) from hww.customer");
