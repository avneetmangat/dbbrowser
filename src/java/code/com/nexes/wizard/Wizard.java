...
//    }
  ...
  static {
            ...
            try { 
                ...
                BACK_TEXT = InternationalizationManager.getInstance().getMessage("dbbrowser-export-wizard", "dbbrowser-ui-export-wizard-previous-button-label", null);
                NEXT_TEXT = InternationalizationManager.getInstance().getMessage("dbbrowser-export-wizard", "dbbrowser-ui-export-wizard-next-button-label", null);
                CANCEL_TEXT = InternationalizationManager.getInstance().getMessage("dbbrowser-export-wizard", "dbbrowser-ui-export-wizard-cancel-button-label", null);
                FINISH_TEXT = InternationalizationManager.getInstance().getMessage("dbbrowser-export-wizard", "dbbrowser-ui-export-wizard-finish-button-label", null);
                
                BACK_ICON = new ImageIcon(PropertyManager.getInstance().getProperty("dbbrowser-ui-view-record-window-previous-record-icon"));
                NEXT_ICON = new ImageIcon(PropertyManager.getInstance().getProperty("dbbrowser-ui-view-record-window-next-record-icon"));
                CANCEL_ICON = new ImageIcon(PropertyManager.getInstance().getProperty("dbbrowser-ui-cross-icon"));
                FINISH_ICON = new ImageIcon(PropertyManager.getInstance().getProperty("dbbrowser-ui-view-record-window-update-record-icon"));
            
            } 
            catch (MissingResourceException mre) 
            {
            	Log.getInstance().warnMessage("Icons not setup in Wizard", Wizard.class.getName());
            }
        }    
