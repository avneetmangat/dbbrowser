...
public class TestGMail
{
	...
	private static final String emailFromAddress = "anu.mangat@gmail.com";
	private static final String SSL_FACTORY = "javax.net.ssl.SSLSocketFactory";
	private static final String[] sendTo = { "anu_in_uk@hotmail.com"};
	...
	public static void main(String args[]) throws Exception
	{
		...
		new TestGMail().sendSSLMessage(sendTo, emailSubjectTxt,
